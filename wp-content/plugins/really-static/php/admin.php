...
//
	...
	';
#if(loaddaten("rs_donationid")=="")echo 'strID="#rs_start";';
...
<img alt="" border="0" src="https://www.paypal.com/'.$ll.'/i/scr/pixel.gif" width="1" height="1">
  ...
  '.testfornewversion();
  elseif(loaddaten("rs_donationid")!="-")echo "<h2>License</h2>".loaddaten("rs_donationid");
else{
